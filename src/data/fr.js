export const fr = {
  ...
  site: {
    ...
    sections: {
      ...
      about: {
        ...
        body: "Curieux et motivé, je travaille pour devenir développeur full-stack. Grandir à Maurice a forgé mon regard pour le design, tandis que mon parcours en biologie marine m'apporte logique, raisonnement et organisation dans mon travail.",
      },
      skills: {
  ...
  projects: [
    ...
    },
    {
      ...
      heroImage: "/image/projects/6.jpg",
      year: "2026",
      role: "Développeur créatif",
      status: "refonte",
      projectHref: "#",
      ...
      galleryImages: Array.from({ length: 8 }, (_, index) => ({
        id: `new-one-by-c-placeholder-${index + 1}`,
        src: null,
      })),
      cover: null,
      hero: null,
    ...
    },
    {
      ...
      heroImage: "/image/projects/7.jpg",
      year: "2025",
    ...
    },
    {
      ...
      heroImage: "/image/projects/2.jpg",
      year: "2025",
